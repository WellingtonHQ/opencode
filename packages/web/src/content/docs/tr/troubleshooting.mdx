...
Ortamda `OPENCODE_SERVER_PORT` ayarliysa desktop uygulamasi yerel sunucu icin o portu kullanmaya calisir.

- `OPENCODE_SERVER_PORT` degerini kaldirin (veya bos bir port secin) ve yeniden baslatin
