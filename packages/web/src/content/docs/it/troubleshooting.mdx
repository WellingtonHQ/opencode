...
Se hai `OPENCODE_SERVER_PORT` impostato nell'ambiente, l'app desktop provera a usare quella porta per il server locale.

- Rimuovi `OPENCODE_SERVER_PORT` (o scegli una porta libera) e riavvia.
