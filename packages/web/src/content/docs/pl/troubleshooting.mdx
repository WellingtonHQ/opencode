...
Jeśli w swoim środowisku masz ustawiony `OPENCODE_SERVER_PORT`, aplikacja komputerowa spróbuje użyć tego portu dla serwera lokalnego.

- usuń `OPENCODE_SERVER_PORT` (lub wybierz wolny port) i uruchom ponownie.
