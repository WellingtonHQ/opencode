...
If you have `OPENCODE_SERVER_PORT` set in your environment, the desktop app will try to use that port for the local server.

- Unset `OPENCODE_SERVER_PORT` (or pick a free port) and restart.
