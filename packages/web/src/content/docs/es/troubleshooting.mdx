...
Si tiene `OPENCODE_SERVER_PORT` configurado en su entorno, la aplicación de escritorio intentará usar ese puerto para el servidor local.

- Desarme `OPENCODE_SERVER_PORT` (o elija un puerto libre) y reinicie.
