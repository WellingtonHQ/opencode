...
Ako ste postavili `OPENCODE_SERVER_PORT` u svom okruženju, desktop aplikacija će pokušati da koristi taj port za lokalni server.

- Poništite `OPENCODE_SERVER_PORT` (ili odaberite slobodan port) i ponovo pokrenite.
