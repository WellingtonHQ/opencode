...
const Endpoint9_0 = (raw: RawClient["server.schedule"]) => () =>
  raw["schedule.list"]({}).pipe(Effect.mapError(mapClientError))

type Endpoint9_1Request = Parameters<RawClient["server.schedule"]["schedule.get"]>[0]
type Endpoint9_1Input = { readonly scheduleID: Endpoint9_1Request["params"]["scheduleID"] }
const Endpoint9_1 = (raw: RawClient["server.schedule"]) => (input: Endpoint9_1Input) =>
  raw["schedule.get"]({ params: { scheduleID: input["scheduleID"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint9_2Request = Parameters<RawClient["server.schedule"]["schedule.create"]>[0]
type Endpoint9_2Input = {
  readonly name?: Endpoint9_2Request["payload"]["name"]
...
type Endpoint9_3Request = Parameters<RawClient["server.schedule"]["schedule.update"]>[0]
type Endpoint9_3Input = {
  readonly scheduleID: Endpoint9_3Request["params"]["scheduleID"]
  readonly name?: Endpoint9_3Request["payload"]["name"]
...
const Endpoint9_3 = (raw: RawClient["server.schedule"]) => (input: Endpoint9_3Input) =>
  raw["schedule.update"]({
...
type Endpoint9_4Request = Parameters<RawClient["server.schedule"]["schedule.remove"]>[0]
type Endpoint9_4Input = { readonly scheduleID: Endpoint9_4Request["params"]["scheduleID"] }
const Endpoint9_4 = (raw: RawClient["server.schedule"]) => (input: Endpoint9_4Input) =>
  raw["schedule.remove"]({ params: { scheduleID: input["scheduleID"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint9_5Request = Parameters<RawClient["server.schedule"]["schedule.runNow"]>[0]
type Endpoint9_5Input = { readonly scheduleID: Endpoint9_5Request["params"]["scheduleID"] }
const Endpoint9_5 = (raw: RawClient["server.schedule"]) => (input: Endpoint9_5Input) =>
  raw["schedule.runNow"]({ params: { scheduleID: input["scheduleID"] } }).pipe(Effect.mapError(mapClientError))

const adaptGroup9 = (raw: RawClient["server.schedule"]) => ({
  list: Endpoint9_0(raw),
  get: Endpoint9_1(raw),
  create: Endpoint9_2(raw),
  update: Endpoint9_3(raw),
  remove: Endpoint9_4(raw),
  runNow: Endpoint9_5(raw),
})
...
const adaptClient = (raw: RawClient) => ({
  ...
  "server.schedule": adaptGroup9(raw["server.schedule"]),
