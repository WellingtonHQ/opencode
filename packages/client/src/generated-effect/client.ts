...
type Endpoint1_0Request = Parameters<RawClient["server.schedule"]["schedule.list"]>[0]
type Endpoint1_0Input = { readonly directory?: Endpoint1_0Request["query"]["directory"] }
const Endpoint1_0 = (raw: RawClient["server.schedule"]) => (input?: Endpoint1_0Input) =>
  raw["schedule.list"]({ query: { directory: input?.["directory"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint1_1Request = Parameters<RawClient["server.schedule"]["schedule.create"]>[0]
type Endpoint1_1Input = {
  readonly name: Endpoint1_1Request["payload"]["name"]
  readonly promptText: Endpoint1_1Request["payload"]["promptText"]
  readonly spec: Endpoint1_1Request["payload"]["spec"]
  readonly agentId?: Endpoint1_1Request["payload"]["agentId"]
  readonly model?: Endpoint1_1Request["payload"]["model"]
  readonly permissionPolicy?: Endpoint1_1Request["payload"]["permissionPolicy"]
  readonly directory?: Endpoint1_1Request["payload"]["directory"]
}
const Endpoint1_1 = (raw: RawClient["server.schedule"]) => (input: Endpoint1_1Input) =>
  raw["schedule.create"]({
    payload: {
      name: input["name"],
...
type Endpoint1_2Request = Parameters<RawClient["server.schedule"]["schedule.get"]>[0]
type Endpoint1_2Input = { readonly id: Endpoint1_2Request["params"]["id"] }
const Endpoint1_2 = (raw: RawClient["server.schedule"]) => (input: Endpoint1_2Input) =>
  raw["schedule.get"]({ params: { id: input["id"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint1_3Request = Parameters<RawClient["server.schedule"]["schedule.update"]>[0]
type Endpoint1_3Input = {
  readonly id: Endpoint1_3Request["params"]["id"]
  readonly name?: Endpoint1_3Request["payload"]["name"]
  readonly promptText?: Endpoint1_3Request["payload"]["promptText"]
  readonly spec?: Endpoint1_3Request["payload"]["spec"]
  readonly agentId?: Endpoint1_3Request["payload"]["agentId"]
  readonly model?: Endpoint1_3Request["payload"]["model"]
  readonly permissionPolicy?: Endpoint1_3Request["payload"]["permissionPolicy"]
  readonly directory?: Endpoint1_3Request["payload"]["directory"]
  readonly enabled?: Endpoint1_3Request["payload"]["enabled"]
}
const Endpoint1_3 = (raw: RawClient["server.schedule"]) => (input: Endpoint1_3Input) =>
  raw["schedule.update"]({
    params: { id: input["id"] },
    payload: {
      name: input["name"],
...
type Endpoint1_4Request = Parameters<RawClient["server.schedule"]["schedule.remove"]>[0]
type Endpoint1_4Input = { readonly id: Endpoint1_4Request["params"]["id"] }
const Endpoint1_4 = (raw: RawClient["server.schedule"]) => (input: Endpoint1_4Input) =>
  raw["schedule.remove"]({ params: { id: input["id"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint1_5Request = Parameters<RawClient["server.schedule"]["schedule.run"]>[0]
type Endpoint1_5Input = { readonly id: Endpoint1_5Request["params"]["id"] }
const Endpoint1_5 = (raw: RawClient["server.schedule"]) => (input: Endpoint1_5Input) =>
  raw["schedule.run"]({ params: { id: input["id"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint1_6Request = Parameters<RawClient["server.schedule"]["schedule.runs"]>[0]
type Endpoint1_6Input = {
  readonly id: Endpoint1_6Request["params"]["id"]
  readonly limit?: Endpoint1_6Request["query"]["limit"]
}
const Endpoint1_6 = (raw: RawClient["server.schedule"]) => (input: Endpoint1_6Input) =>
  raw["schedule.runs"]({ params: { id: input["id"] }, query: { limit: input["limit"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

const adaptGroup1 = (raw: RawClient["server.schedule"]) => ({
  list: Endpoint1_0(raw),
  create: Endpoint1_1(raw),
  get: Endpoint1_2(raw),
  update: Endpoint1_3(raw),
  remove: Endpoint1_4(raw),
  run: Endpoint1_5(raw),
  runs: Endpoint1_6(raw),
})
...
const adaptClient = (raw: RawClient) => ({
  ...
  schedules: adaptGroup1(raw["server.schedule"]),
