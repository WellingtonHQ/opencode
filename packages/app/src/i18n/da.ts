export const dict = {
  ...
  "schedule.panel.new": "New schedule",
  "schedule.panel.error": "Couldn't load schedules.",
  "schedule.empty.title": "No schedules yet",
  "schedule.empty.hint": "Create a schedule to run a prompt automatically.",
  "schedule.row.runNow": "Run now",
  "schedule.row.enable": "Enable {{name}}",
  "schedule.row.disable": "Disable {{name}}",
  "schedule.delete.title": "Delete schedule?",
  "schedule.delete.body": "{{name}} will stop running automatically. Sessions it created are kept.",
  "schedule.dialog.add.title": "New schedule",
  "schedule.dialog.edit.title": "Edit schedule",
  "schedule.dialog.name.label": "Name",
  "schedule.dialog.name.placeholder": "Weekly status update",
  "schedule.dialog.prompt.label": "Prompt",
  "schedule.dialog.prompt.placeholder": "What should OpenCode do?",
  "schedule.dialog.prompt.required": "A prompt is required.",
  "schedule.dialog.project.label": "Project folder",
  ...
  "schedule.dialog.frequency.cron": "Cron",
  "schedule.dialog.field.datetime": "Date and time",
  "schedule.dialog.field.time": "Time",
  "schedule.dialog.error.past": "Pick a date in the future.",
  "schedule.dialog.error.days": "Pick at least one day.",
  "schedule.dialog.error.cron": "That does not look like a valid cron expression.",
  "schedule.dialog.cron.label": "Cron expression",
  "schedule.dialog.cron.placeholder": "0 9 * * 1-5",
  "schedule.dialog.cron.hint": "Five fields: minute, hour, day of month, month, day of week (0-6).",
  "schedule.dialog.nextRun.label": "Next run",
