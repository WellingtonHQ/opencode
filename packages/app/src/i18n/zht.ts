...
export const dict = {
  ...
  "schedule.empty.title": "No schedules yet",
  "schedule.empty.body": "Create a schedule to run a prompt automatically.",
  "schedule.paused": "Paused",
  "schedule.spec.daily": "Every day at {{time}}",
  "schedule.spec.weekly": "Every week on {{days}} at {{time}}",
  "schedule.spec.oneShot": "{{date}} at {{time}}",
  "schedule.row.edit": "Edit",
  "schedule.row.delete": "Delete",
  "dialog.schedule.title.create": "New schedule",
  "dialog.schedule.title.edit": "Edit schedule",
  "dialog.schedule.name.label": "Name",
  "dialog.schedule.name.placeholder": "e.g. Morning code review",
  ...
  "schedule.form.kind.weekly": "Weekly",
  "schedule.form.kind.cron": "Cron expression",
  "dialog.schedule.date.label": "Date",
  "dialog.schedule.time.label": "Time",
  "dialog.schedule.days.label": "Days",
  "dialog.schedule.cron.placeholder": "0 9 * * 1-5",
  "dialog.schedule.confirm.create": "Create schedule",
  "schedule.error.nameRequired": "Name is required",
  "schedule.error.promptRequired": "Prompt is required",
  "schedule.error.timeRequired": "Pick a time",
  "schedule.error.oneShotTimeRequired": "Pick a date and time",
  "schedule.error.daysRequired": "Select at least one day",
  "schedule.error.pastOneShot": "The scheduled time has already passed",
  "schedule.error.cronInvalid": "Enter a valid cron expression, like 0 9 * * 1-5",
  "dialog.schedule.delete.title": "Delete schedule?",
  "dialog.schedule.delete.body": "Future runs stop immediately. Sessions that already started are kept.",
  "schedule.active": "Active",
  "schedule.nextRun": "Next run",
  "schedule.row.runNow": "Run now",
  "schedule.status.ran": "Ran",
  "schedule.status.missed": "Missed",
  "schedule.status.failed": "Failed",
  "toast.schedule.ran.title": "Schedule run started",} satisfies Partial<Record<Keys, string>>
