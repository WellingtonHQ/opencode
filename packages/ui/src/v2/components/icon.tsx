...
const icons = {
  ...
  clock: {
    viewBox: "0 0 16 16",
    body: `<path d="M8 1.55566C4.44094 1.55566 1.55566 4.44094 1.55566 8C1.55566 11.5591 4.44094 14.4444 8 14.4444C11.5591 14.4444 14.4444 11.5591 14.4444 8C14.4444 4.44094 11.5591 1.55566 8 1.55566Z" stroke="currentColor"/><path d="M8 4.66632V8L10 9.33333" stroke="currentColor" stroke-linecap="square"/>`,
  },
  "sidebar-right": {
    viewBox: "0 0 20 20",
  ...
  play: {
    viewBox: "0 0 16 16",
    body: `<path d="M4.5 2.9L13 8L4.5 13.1V2.9Z" stroke="currentColor" stroke-linejoin="round"/>`,
  },
  trash: {
    viewBox: "0 0 16 16",
    body: `<path d="M2.75 4.25H13.25M5.75 4.25V2.9C5.75 2.35 6.19 1.9 6.75 1.9H9.25C9.8 1.9 10.25 2.35 10.25 2.9V4.25M4.4 4.25L4.96 12.95C5 13.57 5.5 14.1 6.12 14.1H9.88C10.5 14.1 11 13.57 11.04 12.95L11.6 4.25M6.5 6.9V11.4M8 6.9V11.4M9.5 6.9V11.4" stroke="currentColor" stroke-miterlimit="10" stroke-linecap="square"/>`,
  },
  "outline-xmark": {
    viewBox: "0 0 16 16",
